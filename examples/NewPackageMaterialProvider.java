package some.package.of.yours; /* POSSIBLY CHANGE THIS PACKAGE */
...
public class NewPackageMaterialProvider implements GoPlugin {
    ...
    public NewPackageMaterialProvider() {
        replacementProvider = new ReplacementProvider(new YourOriginalProviderWhichHadExtensionAnnotationOnIt()); /* CHANGE THIS TO POINT TO YOUR ORIGINAL ENTRYPOINT */
    }
